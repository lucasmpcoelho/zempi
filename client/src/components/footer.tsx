      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <Link href="/">
              <h3 className="font-serif text-3xl font-bold tracking-tight mb-6 cursor-pointer hover:opacity-80 transition-opacity">LYVE</h3>
            </Link>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-muted-foreground font-light">
          <p>© {new Date().getFullYear()} Lyve. Todos os direitos reservados.</p>
